...
public class CartFrame extends javax.swing.JFrame {
    ...
    private void loadTable() {
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel(); // jTable1 là tên bảng, bạn đổi nếu cần
        model.setRowCount(0); // clear dữ liệu cũ

        int tongTien = 0;

        for (Product p : Cart.getDanhSach()) {
            Object[] row = {p.getTen(), p.getGia()};
            model.addRow(row);
            tongTien += p.getGia();
        }

        jLabelTong.setText("Tổng tiền: " + tongTien + " VNĐ"); // nếu có label tổng tiền
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new TToan().setVisible(true);
        this.dispose(); // nếu muốn đóng giỏ hàng khi mở form thanh toán        // TODO add your handling code here:
